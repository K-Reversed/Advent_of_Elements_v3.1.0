...
public class Fire extends Spell{
    ...
    public Fire(int x, int y, ID id, Handler handler, HUD hud) {
        ...
        try {
            spriteSheet = ImageIO.read(Objects.requireNonNull(getClass().getResource("res/png/SpriteSheets/Fireball Sprite Sheet.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void tick() {
        super.tick();
        //handler.addObject(new Others.Trail(x - 8, y + 8, Others.ID.Others.Trail, handler, 16, 16, 0.1f, new Color(200, 0 ,0)));
    }

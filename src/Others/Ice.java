...
public class Ice extends Spell{
    ...
    public Ice (int x, int y, ID id, Handler handler, HUD hud) {
        ...
        try {
            spriteSheet = ImageIO.read(Objects.requireNonNull(getClass().getResource("res/png/SpriteSheets/Ice Spear Sprite Sheet.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void tick() {
        ...
        //handler.addObject(new Others.Trail(x, y, Others.ID.Others.Trail, handler, 1, 5, 0.01f, new Color(0, 255, 255)));
        collision();
    }

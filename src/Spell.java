...
public abstract class Spell extends GameObject{
    ...
    public void spellSprites (){
        try {
            fireBallSpriteSheet = ImageIO.read(Objects.requireNonNull(getClass().getResource("res/png/spellSpriteSheets/Fireball Sprite Sheet.png")));
            windMagicCircleSpriteSheet = ImageIO.read(Objects.requireNonNull(getClass().getResource("res/png/spellSpriteSheets/Wind Magic Circle Sprite Sheet.png")));
        } catch (IOException e){
            e.printStackTrace();
        }
    }
